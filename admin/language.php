    ...
    <div class="col-md-12">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Искать плагин <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[2]" value="<?php echo $lang_ids[2]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Поиск <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Обновить <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <h3 style="font-size:20px;font-weight:500;">Войти</h3>
		<div class="box box-info">
            <div class="box-body">
				<div class="form-group">
