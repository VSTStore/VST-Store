...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Смотреть все</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Текущее фото</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="padding-top:5px">
								<input type="file" name="photo">(только jpg, jpeg, gif и png поддерживается)
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Верх </label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">URL кнопки </label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<select name="position" class="form-control">
									<option value="Left" <?php if($position == 'Left') {echo 'selected';} ?>>Лево</option>
									<option value="Center" <?php if($position == 'Center') {echo 'selected';} ?>>Центр</option>
									<option value="Right" <?php if($position == 'Right') {echo 'selected';} ?>>Право</option>
								</select>
							</div>
						</div>				
						<div class="form-group">
