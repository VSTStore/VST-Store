...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['faq_content'])) {
		$valid = 0;
		$error_message .= 'Содержимое не может быть пустым<br>';
	}
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Просмотр всех</a>
	</div>
</section>
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Текст <span>*</span></label>
							<div class="col-sm-9">
