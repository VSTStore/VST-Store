...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Информация о нас успешно обновлена.';
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Информация на странице часто задаваемых вопросов успешно обновлена.';
...
if(isset($_POST['form_contact'])) {
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'YВам необходимо загрузить файл в формате jpg, jpeg, gif или png.<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Информация на странице контактов успешно обновлена.';
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_4" data-toggle="tab">контакты</a></li>
