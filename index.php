...
<div class="product pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php echo 'РЕКОМЕНДУЕМЫЕ ПЛАГИНЫ'; ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><i class="fa fa-shopping-cart"></i> Добавить в корзину</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
...
<div class="product bg-gray pt_70 pb_30">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php echo "САМЫЕ ПОПУЛЯРНЫЕ ПЛАГИНЫ"; ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
