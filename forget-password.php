...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>'.LANG_VALUE_142.'<br> <a href="'.BASE_URL.'https://vststore.ru/reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">кликните сюда</a>';
        
        $to      = $_POST['cust_email'];
        $subject = LANG_VALUE_143;
        $headers = "От: noreply@" . BASE_URL . "\r\n" .
                   "Ответить на: noreply@" . BASE_URL . "\r\n" .
